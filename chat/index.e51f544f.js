...
})({"cQvJf":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "810d4221e51f544f";
"use strict";
...
},{}],"fsm5S":[function(require,module,exports) {
...
var _message = require("../VIEV/message");
...
const wrapView = async ()=>{
    ...
    history.messages.forEach(({ text , user , createdAt  })=>{
        div.append((0, _message.messageAdding)(text, createdAt, user, "delivered"));
    });
    main.replaceChild(div, mainView);
};
wrapView();

},{"sweetalert2":"1HyFr","../MODEL/userInfo":"4Vf3O","../VIEV/message":"45cIe","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1HyFr":[function(require,module,exports) {
/*!
* sweetalert2 v11.7.1
...
},{}],"4Vf3O":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class USERINFO {
    constructor(){
        this.email = (0, _jsCookieDefault.default).get("email");
        this.token = (0, _jsCookieDefault.default).get("token");
    }
    get name() {
...
const messageSend = (event)=>{
    ...
    mainView.prepend(messageAdding(messageText.value.trim()));
    socket.send(JSON.stringify({
        text: messageText.value.trim()
    }));
    messageText.value = "";
    socket.onmessage = ()=>{
        (0, _getMessages.wrapView)();
    };
};
(0, _uiElementsDefault.default).MESSAGE_SEND_FORM.addEventListener("submit", messageSend);

},{"sweetalert2":"1HyFr","date-fns":"9yHCA","./ui_elements":"j35iY","../MODEL/userInfo":"4Vf3O","../CONTROLLER/ws":"ell9R","../CONTROLLER/getMessages":"fsm5S","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9yHCA":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ell9R":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _userInfo = require("../MODEL/userInfo");
var _userInfoDefault = parcelHelpers.interopDefault(_userInfo);
...
},{"../MODEL/userInfo":"4Vf3O","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cQvJf","fsm5S"], "fsm5S", "parcelRequire25d8")

//# sourceMappingURL=index.e51f544f.js.map
