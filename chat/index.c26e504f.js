...
})({"4t1fB":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "d6ff7df0c26e504f";
"use strict";
...
},{}],"gG7pW":[function(require,module,exports) {
...
const enterCode = async (code, email)=>{
    const url = `https://edu.strada.one/api/user/me?${email}`;
    try {
...
const codeInput = ({ email  })=>{
    (0, _sweetalert2Default.default).fire({
        ...
        preConfirm: (val)=>enterCode(val, email),
...
const getCode = async (email)=>{
    ...
    try {
        ...
        if (response.ok) codeInput(dataJson);
...
const enterToApp = ()=>{
    if (!(0, _userInfoDefault.default).name || !(0, _userInfoDefault.default).email || !(0, _userInfoDefault.default).token) (0, _sweetalert2Default.default).fire({
        title: "Авторизация",
        input: "email",
        inputLabel: "Почта",
        ...
        allowEscapeKey: false,
        allowOutsideClick: false,
        confirmButtonText: "Получить код",
        showCancelButton: true,
        cancelButtonText: "Ввести код",
        preConfirm: getCode,
        showLoaderOnConfirm: true,
        willClose: codeInput
    });
};
document.addEventListener("DOMContentLoaded", enterToApp);

},{"sweetalert2":"1HyFr","../MODEL/userInfo":"4Vf3O","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1HyFr":[function(require,module,exports) {
/*!
* sweetalert2 v11.7.1
...
},{}]},["4t1fB","gG7pW"], "gG7pW", "parcelRequire25d8")

//# sourceMappingURL=index.c26e504f.js.map
