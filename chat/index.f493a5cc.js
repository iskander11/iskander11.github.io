...
})({"fCsET":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "e0d806f0f493a5cc";
"use strict";
...
},{}],"45cIe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "wrapView", ()=>wrapView);
parcelHelpers.export(exports, "messageAdding", ()=>messageAdding);
...
var _uiElementsDefault = parcelHelpers.interopDefault(_uiElements);
var _userInfo = require("../MODEL/userInfo");
var _userInfoDefault = parcelHelpers.interopDefault(_userInfo);
var _ws = require("../CONTROLLER/ws");
var _wsDefault = parcelHelpers.interopDefault(_ws);
var _getMessages = require("../CONTROLLER/getMessages");
const messageOnScroll = (block, array)=>{
    if (!array.length) {
        (0, _sweetalert2Default.default).fire({
            title: "Вся история загружена"
        });
        return;
    }
    for(let i = 0; i < 20; i++){
        const message = array.shift();
        block.prepend(messageAdding(message.text, message.createdAt, message.user, "delivered"));
    }
};
const wrapView = async ()=>{
    console.log((0, _userInfoDefault.default));
    const history = await (0, _getMessages.getMessages)();
    console.log(history);
    if (!history) return;
    const mainView = document.querySelector(".main-view");
    const div = document.createElement("div");
    div.classList.add("main-view");
    messageOnScroll(div, history.messages);
    // div.prepend(messageAdding(text,createdAt,user,'delivered'))
    div.addEventListener("scroll", (event)=>{
        const scrollTop = event.target.scrollTop;
        if (scrollTop === 0) messageOnScroll(div, history.messages);
    });
    (0, _uiElementsDefault.default).MAIN.replaceChild(div, mainView);
    div.scrollTop = div.scrollHeight;
};
wrapView();
const messageAdding = (message, time = Date.now(), sender = (0, _userInfoDefault.default), condition = "sending")=>{
    const messageFragment = (0, _uiElementsDefault.default).MESSAGE_TEMPLATE.content.cloneNode(true);
    const messageText = messageFragment.querySelector(".main-view-message_text");
    const login = messageFragment.querySelector(".main-view-message_text_user");
    login.textContent = `${sender.name} : `;
    messageText.textContent = message;
    messageText.prepend(login);
    const messageBlock = messageFragment.querySelector(".main-view-message");
    messageBlock.classList.add(condition);
    messageBlock.dataset.email = sender.email;
    const position = sender.email === (0, _userInfoDefault.default).email ? "user" : "companion";
    messageBlock.classList.add(position);
    const messageTime = messageFragment.querySelector(".main-view-message_time");
    messageTime.textContent = (0, _dateFns.format)(new Date(time), "HH:mm");
    return messageFragment;
};
const socket = (0, _wsDefault.default)();
const messageSend = (event)=>{
    const mainView = document.querySelector(".main-view");
    event.preventDefault();
    const messageText = event.target.querySelector(".main-form_input");
    ...
    const userMessage = messageAdding(messageText.value.trim());
    mainView.append(userMessage);
...
socket.onmessage = (event)=>{
    ...
    const mainView = document.querySelector(".main-view");
    const sendingMessage = mainView.querySelector(".sending");
    if (sendingMessage) {
        const sendingText = sendingMessage.querySelector(".main-view-message_text").textContent.slice((0, _userInfoDefault.default).name.length + 3);
        const sendingTime = sendingMessage.querySelector(".main-view-message_time").textContent;
        const sendingEmail = sendingMessage.dataset.email;
        const timeCondition = sendingTime === (0, _dateFns.format)(new Date(messageInfo.createdAt), "HH:mm");
        if (sendingEmail === messageInfo.user.email && sendingText === messageInfo.text && timeCondition) {
            sendingMessage.classList.remove("sending");
            sendingMessage.classList.add("delivered");
            mainView.scrollTop = mainView.scrollHeight;
            return;
        }
    }
    mainView.append(messageAdding(messageInfo.text, messageInfo.createdAt, messageInfo.user, "delivered"));
    mainView.scrollTop = mainView.scrollHeight;
};
socket.onclose = ()=>{
    (0, _sweetalert2Default.default).fire({
        title: "Соединение с чатом потеряно,перезагрузите страницу!",
...
(0, _uiElementsDefault.default).MESSAGE_SEND_FORM.addEventListener("submit", messageSend);

},{"sweetalert2":"1HyFr","date-fns":"9yHCA","./ui_elements":"j35iY","../MODEL/userInfo":"4Vf3O","../CONTROLLER/ws":"ell9R","../CONTROLLER/getMessages":"fsm5S","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1HyFr":[function(require,module,exports) {
/*!
* sweetalert2 v11.7.1
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"j35iY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const UI_ELEMENTS = {
    MESSAGE_SEND_FORM: document.querySelector(".main-form"),
    MESSAGE_TEMPLATE: document.querySelector("#message_template"),
    SETTINGS: document.querySelector(".main-options_settings"),
    MAIN_VIEW: document.querySelector(".main-view"),
    MAIN: document.querySelector(".main"),
    EXIT: document.querySelector(".main-options_exit")
};
exports.default = UI_ELEMENTS;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4Vf3O":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class USERINFO {
    get email() {
        return (0, _jsCookieDefault.default).get("email");
    }
    get token() {
        return (0, _jsCookieDefault.default).get("token") === "undefined" ? undefined : (0, _jsCookieDefault.default).get("token");
    }
    get name() {
        return (0, _jsCookieDefault.default).get("username");
    }
    set name(newName) {
        (0, _jsCookieDefault.default).set("username", newName, {
            expires: 7
        });
    }
    delete() {
...
const saveUser = ({ name , email , token  })=>{
    (0, _jsCookieDefault.default).set("username", name, {
        expires: 7
    });
...
},{}],"ell9R":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _userInfo = require("../MODEL/userInfo");
var _userInfoDefault = parcelHelpers.interopDefault(_userInfo);
const SOCKET = ()=>{
    return new WebSocket(`wss://edu.strada.one/websockets?${(0, _userInfoDefault.default).token}`);
};
exports.default = SOCKET;

},{"../MODEL/userInfo":"4Vf3O","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fsm5S":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const getMessages = async ()=>{
    if (!(0, _userInfoDefault.default).token) return;
    ...
    try {
        const response = await fetch(url, {
            ...
            headers: {
                ...
                "Authorization": `Bearer ${(0, _userInfoDefault.default).token}`
            }
        });
        if (!response.ok) (0, _sweetalert2Default.default).fire({
...
},{"sweetalert2":"1HyFr","../MODEL/userInfo":"4Vf3O","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fCsET","45cIe"], "45cIe", "parcelRequire25d8")

//# sourceMappingURL=index.f493a5cc.js.map
