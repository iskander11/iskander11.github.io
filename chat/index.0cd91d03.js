...
})({"4aud2":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "cb448ccf0cd91d03";
"use strict";
...
},{}],"c7Mbj":[function(require,module,exports) {
...
const changeUserName = async (newName)=>{
    ...
    try {
        ...
        (0, _sweetalert2Default.default).fire({
            title: `Ваше новое имя: ${userInfo.name}`
        });
        (0, _userInfoDefault.default).username = userInfo.name;
    } catch (error) {
        (0, _sweetalert2Default.default).fire({
            title: error.message
        });
...
const settingsHandle = ()=>{
    (0, _sweetalert2Default.default).fire({
        ...
        inputValue: (0, _userInfoDefault.default).username,
        inputAttributes: {
            "autocomplete": "off"
        },
        confirmButtonText: "Изменить имя",
        showLoaderOnConfirm: true,
        backdrop: "#535353",
        showCancelButton: true,
        cancelButtonText: "Закрыть",
        preConfirm: changeUserName
    });
};
(0, _uiElementsDefault.default).SETTINGS.addEventListener("click", settingsHandle);

},{"./ui_elements":"j35iY","sweetalert2":"1HyFr","../MODEL/userInfo":"4Vf3O","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"j35iY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["4aud2","c7Mbj"], "c7Mbj", "parcelRequire25d8")

//# sourceMappingURL=index.0cd91d03.js.map
